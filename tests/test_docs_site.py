...
DEPRECATED_CHECKOUT_SHA = "93cb6efe18208431cddfb8368fd83d5badbf9bfd"
DEPRECATED_SETUP_PYTHON_SHA = "a26af69be951a213d495a4c3e4e4022e16d87065"
CURRENT_CHECKOUT_SHA = "de0fac2e4500dabe0009e67214ff5f5447ce83dd"
...
class DocsSiteBuildTests(unittest.TestCase):
    ...
    def test_mkdocs_configuration_and_workflows_are_present(self) -> None:
        ...
        self.assertIn("cibuildwheel", release_workflow)
